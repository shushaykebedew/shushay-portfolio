    ...
    >
      ...
      >
        <div
          ...
          style={{
            ...
            top: mousePos.y - 260,
            background:
              "radial-gradient(circle, rgba(99,102,241,0.12) 0%, rgba(139,92,246,0.06) 45%, transparent 70%)",
      ...
      <div className="relative z-10 max-w-7xl 2xl:max-w-[1760px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-8 grid lg:grid-cols-12 gap-10 sm:gap-14 lg:gap-16 2xl:gap-20 items-center w-full">
        ...
        >
          ...
          >
            <div className="glass-card inline-flex items-center gap-2 rounded-full px-3 sm:px-4 2xl:px-5 py-1 sm:py-1.5 2xl:py-2 text-[10px] sm:text-xs 2xl:text-sm font-bold tracking-wide hover:scale-105 transition-transform text-emerald-700 dark:text-emerald-400">
              <span className="relative flex h-2 w-2 2xl:h-2.5 2xl:w-2.5 flex-shrink-0">
                ...
                <span className="relative inline-flex rounded-full h-2 w-2 2xl:h-2.5 2xl:w-2.5 bg-emerald-500" />
              </span>
          ...
          {/* Heading */}
          <motion.h1
            className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl font-extrabold mb-4 sm:mb-6 2xl:mb-8 leading-[1.1] tracking-tight text-slate-900 dark:text-white"
            variants={itemVariants}
          >
            Hi, I'm{" "}
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            <strong className="text-slate-900 dark:text-white font-bold">Full Stack Developer</strong>{" "}
            specializing in robust frontend architectures and pixel-perfect implementations. I build
            scalable web applications using modern technologies, delivering seamless user experiences
          ...
          >
            ...
            <a
              href="#projects"
              className="group/btn relative w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 2xl:px-7 2xl:py-3.5 rounded-xl sm:rounded-2xl font-semibold text-xs sm:text-sm 2xl:text-base bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 text-white shadow-lg shadow-indigo-500/25 dark:shadow-indigo-500/15 hover:shadow-xl hover:shadow-indigo-500/30 transition-all duration-300 hover:scale-105 focus:outline-none overflow-hidden whitespace-nowrap text-center"
            >
              {/* Shimmer sweep */}
              <span
                className="absolute inset-0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700 ease-in-out bg-gradient-to-r from-transparent via-white/20 to-transparent pointer-events-none"
                aria-hidden="true"
              />
            ...
            <div className="grid grid-cols-3 sm:flex sm:flex-wrap items-center gap-2 sm:gap-3 2xl:gap-4 w-full sm:w-auto">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="group/sec relative inline-flex items-center justify-center gap-1.5 sm:gap-2 px-2.5 xs:px-3 sm:px-5 2xl:px-6 py-2.5 sm:py-3 2xl:py-3.5 rounded-xl sm:rounded-2xl font-semibold text-xs sm:text-sm 2xl:text-base glass-card text-slate-700 dark:text-slate-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all duration-300 hover:scale-105 focus:outline-none overflow-hidden whitespace-nowrap text-center"
                >
                  {/* Shimmer sweep */}
                  <span
                    className="absolute inset-0 -translate-x-full group-hover/sec:translate-x-full transition-transform duration-700 ease-in-out bg-gradient-to-r from-transparent via-indigo-500/10 to-transparent pointer-events-none"
                    aria-hidden="true"
                  />
      ...
      <motion.a
        href="#about"
        className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors focus:outline-none group"
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 1.4, duration: 0.5 }}
        aria-label="Scroll to About section"
      >
        <span className="text-[10px] font-semibold tracking-[0.15em] uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          scroll
        </span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
