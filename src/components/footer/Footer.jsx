...
const socialLinks = [
  { icon: FaFacebookF, link: "https://www.facebook.com/shushay.kebedew", label: "Facebook" },
  { icon: FaLinkedinIn, link: "https://www.linkedin.com/in/shushay-kebedew/", label: "LinkedIn" },
  { icon: FaTwitter, link: "https://x.com/Shushay_Kebedew", label: "X (Twitter)" },
  { icon: FaInstagram, link: "https://www.instagram.com/shushay_kebedew", label: "Instagram" },
  { icon: FaGithub, link: "https://github.com/shushaykebedew", label: "GitHub" },
];
        ...
        <motion.div custom={0} variants={sectionVariants} initial="hidden" animate="visible">
          ...
          <div className="space-y-2.5 text-sm">
            <div className="flex items-center gap-2.5">
              <MapPin size={18} className="text-indigo-600 dark:text-indigo-400 flex-shrink-0" aria-hidden="true" />
              <span className="text-slate-600 dark:text-slate-400">Addis Ababa, Ethiopia</span>
            </div>
            <div className="flex items-center gap-2.5">
              <Phone size={18} className="text-indigo-600 dark:text-indigo-400 flex-shrink-0" aria-hidden="true" />
              <a
            ...
            <div className="flex items-start gap-2.5">
              <Mail size={18} className="text-indigo-600 dark:text-indigo-400 flex-shrink-0 mt-0.5" aria-hidden="true" />
              <a
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-2.5">
            {quickLinks.map((link) => (
              <a
                ...
                className="text-sm text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-sm"
              >
                {link}
              </a>
            ))}
