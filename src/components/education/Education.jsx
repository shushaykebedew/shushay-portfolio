      ...
      <div className="max-w-6xl 2xl:max-w-[1760px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 2xl:gap-10 items-stretch">
          {education.map(({ degree, institute, year, details }, index) => (
            <motion.div
              key={degree}
              className="glass-card p-5 sm:p-7 md:p-8 rounded-2xl sm:rounded-3xl 2xl:rounded-4xl glow-hover flex flex-col justify-between"
              custom={index}
            ...
            >
              <div>
                ...
                <div className="flex items-start gap-3.5 sm:gap-4 2xl:gap-5 mb-5 sm:mb-6 2xl:mb-8">
                  <div className="w-11 h-11 sm:w-13 sm:h-13 2xl:w-16 2xl:h-16 rounded-xl sm:rounded-2xl 2xl:rounded-3xl flex items-center justify-center flex-shrink-0 bg-gradient-to-tr from-indigo-600 to-purple-600 text-white shadow-md">
