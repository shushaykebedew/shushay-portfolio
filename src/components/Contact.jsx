            ...
            >
              ...
              <form className="space-y-4" onSubmit={sendEmail}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-4 py-2 font-semibold text-white shadow hover:bg-indigo-700"
                >
